...
Retain History and Agent changes. Agent changes uses `DiffShell` with the
existing current-chat and selected-turn ranges. Both modes remain in this view
because they depend on chat identity.

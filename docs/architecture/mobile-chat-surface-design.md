...
The redesign keeps the current charcoal and frosted-surface identity. It does not
...
an agent interface. The composer remains a supporting material,
...
The composer keeps the existing frosted material. Its target collapsed

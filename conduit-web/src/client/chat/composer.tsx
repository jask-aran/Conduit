    ...
    <div class="composer">
      ...
      <div class="composer-actions">
        ...
        <div class="composer-actions-right">
          <Show when={props.chat.contextUsage()}><span class="context-ring" aria-label="Context usage">{Math.round((props.chat.contextUsage()?.percent || 0) * (props.chat.contextUsage()?.percent && props.chat.contextUsage()!.percent! <= 1 ? 100 : 1))}%</span></Show>

...
export const CONTEXT_METRIC_OPTIONS = [
  ...
  { id: "lastCostInput", group: "lastRequest", label: "Last input cost", description: "Harness-reported input cost for the latest request." },
  { id: "lastCostOutput", group: "lastRequest", label: "Last output cost", description: "Harness-reported output cost for the latest request." },
  { id: "lastCostCacheRead", group: "lastRequest", label: "Last cache-read cost", description: "Harness-reported cache-read cost for the latest request." },
  { id: "lastCostCacheWrite", group: "lastRequest", label: "Last cache-write cost", description: "Harness-reported cache-write cost for the latest request." },
  { id: "lastCostTotal", group: "lastRequest", label: "Last total cost", description: "Harness-reported total cost for the latest request." },
  ...
  { id: "sessionCost", group: "session", label: "Session total cost", description: "Harness-reported cumulative session cost." },

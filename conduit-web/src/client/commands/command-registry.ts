...
export const commandRegistry: ShortcutCommandDefinition[] = [
  ...
  command({
    id: COMMAND_IDS.workspaceArtifacts,
    label: "Open workspace Artifacts tab",
    description: "Show artifacts in the open workspace panel",
    group: "workspace-panel",
    icon: "workspace-panel",
    keywords: ["workspace", "artifacts", "outputs", "tab"],
    contexts: ["workspace-panel"],

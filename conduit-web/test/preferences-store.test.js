...
test("normalizePreferences falls back when the default template is unknown", () => {
  assert.deepEqual(
    ...
    { defaultTemplateId: "chat", sessionNameModel: "", sessionNameThinkingLevel: "off", profileModelDefaults: {}, terminalShortcuts: [], sidebarPins: [], ...emptyUiPreferences },
  );
  assert.deepEqual(
    normalizePreferences({}, { defaultTemplateId: "gone" }, ["workspace"]),
    { defaultTemplateId: "workspace", sessionNameModel: "", sessionNameThinkingLevel: "off", profileModelDefaults: {}, terminalShortcuts: [], sidebarPins: [], ...emptyUiPreferences },
  );
});

...
- **The answer's place is held.** From the start of a live turn until its answer's first words, a line of faint bars breathes where the answer will be (opacity only, one text line tall), and the words replace it in place, moving nothing.

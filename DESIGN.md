...
- **A stopped turn is one row.** Its trace says "Interrupted", and an answer the stop discarded is the trace's last step, struck through, with "answer not kept" as the header's summary -- never a row of its own. A turn stopped before it did anything is one "Interrupted · before answering" line.
